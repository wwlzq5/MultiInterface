...
public:
    ...
    void setupUi(QWidget *IOCard)
    {
        ...
        IOCard->resize(695, 296);
        layoutWidget = new QWidget(IOCard);
        layoutWidget->setObjectName(QString::fromUtf8("layoutWidget"));
        layoutWidget->setGeometry(QRect(9, 9, 501, 165));
        ...
        gridLayout->addLayout(horizontalLayout_4, 0, 3, 1, 1);
        ...
        gridLayout->addLayout(horizontalLayout_16, 5, 2, 1, 2);
        ...
        gridLayout->addLayout(horizontalLayout_15, 5, 0, 1, 2);
        ...
        gridLayout->addLayout(horizontalLayout_14, 3, 2, 1, 2);
        ...
        gridLayout->addLayout(horizontalLayout_13, 3, 0, 1, 2);
        ...
        gridLayout->addLayout(horizontalLayout_18, 6, 0, 1, 1);
        ...
        layoutWidget1->setGeometry(QRect(10, 170, 501, 121));
        ...
        label_nFailType = new QLabel(layoutWidget1);
        ...
        tableView->setGeometry(QRect(520, 10, 171, 281));
